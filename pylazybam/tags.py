...
def get_int_tag(tag_bytes: bytes,
    ...
    Potential values for the tag parameter include:
        ...
        SM:i:score  Template-independent mapping quality, i.e., the mapping
                    quality if the read were mapped as a single read rather t
                    han as part of a read pair or template.
...
def get_str_tag(tag_bytes: bytes,
    ...
    Potential values for the tag parameter include:
        ...
        Q2:Z:qualities  Phred quality of the mate/next segment sequence in the R2 tag. Same encoding as QUAL. R2:Z:bases Sequence of the mate/next segment in the template. See also Q2 for any associated quality values.
